// rido1607@gmail.com
#include "testSideCrossOrderIter.hpp"
...
TEST_CASE("Test Begin and End"){
    SUBCASE("Test Begin and End on an Empty Container"){
        ...
        auto itBegin = emptyContainer.begin_side_cross_order();

        // get the iterator to the end
        auto itEnd = emptyContainer.end_side_cross_order();
    ...
    SUBCASE("Test Begin and End on a Non-Empty Container"){
        SUBCASE("With One Element"){
            ...
            // get the iterator to the beginning
            auto itBegin = container.begin_side_cross_order();
...
TEST_CASE("Test Iterator from a New Container"){
    ...
    MyContainer<int>::Iterator it = container->begin_side_cross_order();
...
TEST_CASE("Test Operator=="){
    ...
    SUBCASE("Test Comparing Two Iterators of Different Containers"){
        SUBCASE("Test Comparing Two Iterators of Empty Containers"){
            ...
            auto it1 = container1.begin_side_cross_order();
            auto it2 = container2.begin_side_cross_order();
        ...
        SUBCASE("Containers with the Same Variables"){
            ...
            while(it1 != container1.end_side_cross_order() && it2 != container2.end_side_cross_order()) {
                // check that the iterators are not equal
                CHECK(!(it1 == it2));
...
TEST_CASE("Test Accessing Elements"){
    ...
    SUBCASE("Test Accessing Elements of a Container with Multiple Elements"){
        ...
        CHECK(*it == 1); // the smallest element
        ++it; 
        CHECK(*it == 5); // the largest element
        ++it;
        CHECK(*it == 2); // the second smallest element
        ++it;
        CHECK(*it == 4); // the second largest element
        ++it;
        CHECK(*it == 3); // the middle element
    }
    ...
    SUBCASE("Test Accessing a Container of Complex Numbers"){
        ...
        // get the iterator to the beginning of the container
        auto it = complexContainer.begin_side_cross_order();

        // check that the values of the elements are correct
        CHECK(*it == complex(1, 2)); // the smallest element
        ++it;
        CHECK(*it == complex(5, 6)); // the largest element
        ++it;
        CHECK(*it == complex(3, 4)); // the middle element
    }
}
...
TEST_CASE("Test Changing Elements"){
    ...
    SUBCASE("Tests Affected by the Iterator Order"){
        SUBCASE("Test Changing Elements of a Container with Multiple Elements"){
            ...
            ++it;
            ++it;
            *it = 100; // should overwrite the third element which is 2

            // check that the value of the third element is correct
            CHECK(*it == 100);

            // check that the size of the container is still correct
            CHECK(container.size() == 5);

            auto it4 = container.begin_side_cross_order();
            for(;it4 != container.end_side_cross_order(); ++it4) {
                cout<< *it4 << " ";
            }
            ...
            // check that the values of the container are in the expected order
            // since 1 is the smallest element, it should be the first element
            CHECK(*it2 == 1);
            ++it2;
            // since 100 is the biggest element, it should be the second element
            CHECK(*it2 == 100);
            ++it2;
            // the next element should be the second smallest element
            CHECK(*it2 == 3);
            ++it2;
            // the next element should be the second largest element
            CHECK(*it2 == 5);
            ++it2;
            // and the last element should be the middle element
            CHECK(*it2 == 4);
        }
        SUBCASE("Test Changing Last Element"){
            ...
            // change the value of the last element which should be 3
            *it = -5;
            ...
            // check that the values of the container are in the expected order
            // since -5 is now the smallest element, it should be the first element
            CHECK(*it2 == -5);
            ++it2;
            // since 5 is the largest element, it should be the second element
            CHECK(*it2 == 5);
            ++it2;
            // since 1 is the second smallest element, it should be the third element
            CHECK(*it2 == 1);
            ++it2;
            // since 4 is the second largest element, it should be the fourth element
            CHECK(*it2 == 4);
            ++it2;
            // and the last element should be the middle element which is 2
            CHECK(*it2 == 2);

            // check that the internal order of the container is still correct
        ...
        SUBCASE("Test Changing First Element"){
            ...
            // change the value of the first element which should be 1
            *it = 4;
            ...
            // since 2 is now the smallest element, it should be the first element
            CHECK(*it2 == 2);
            ++it2;
            // since 5 is the largest element, it should be the second element
            CHECK(*it2 == 5);
            ++it2;
            // since 3 is the second smallest element, it should be the third element
            CHECK(*it2 == 3);
            ++it2;
            // since 4 is the second largest element, it should be the fourth element
            CHECK(*it2 == 4);
            ++it2;
            // and the last element should be the middle element which is 4
            CHECK(*it2 == 4);
            ++it2;
...
TEST_CASE("Test Correct Order"){
    SUBCASE("Test for Integers"){
        ...
        // create an array with the expected order of the elements
        int expectedOrder[10];
        for(int i = 0; i < 10; ++i) {
            if(i%2 == 0){
                expectedOrder[i] = arr[i/2];
            }
            else{
                expectedOrder[i] = arr[9-(i/2)];
            }
        }
        ...
        // check that the values of the elements are in the expected order
        int i=0;

        for(; it != container.end_side_cross_order(); ++i, ++it) {

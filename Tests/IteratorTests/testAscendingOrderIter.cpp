...
TEST_CASE("Test Begin and End"){
    SUBCASE("Test Begin and End on an Empty Container"){
        ...
        auto itBegin = emptyContainer.begin_ascending_order();

        // get the iterator to the end
        auto itEnd = emptyContainer.end_ascending_order();
    ...
    SUBCASE("Test Begin and End on a Non-Empty Container"){
        SUBCASE("With One Element"){
            ...
            // get the iterator to the beginning
            auto itBegin = container.begin_ascending_order();
...
TEST_CASE("Test Operator=="){
    ...
    SUBCASE("Test Comparing Two Iterators of Different Containers"){
        SUBCASE("Test Comparing Two Iterators of Empty Containers"){
            ...
            auto it2 = container2.begin_ascending_order();
        ...
        SUBCASE("Containers with the Same Variables"){
            ...
            while(it1 != container1.end_ascending_order() && it2 != container2.end_ascending_order()) {
                // check that the iterators are not equal
                CHECK(!(it1 == it2));
    ...
    SUBCASE("Tests Affected by the Iterator Order"){
        SUBCASE("Test Changing Elements of a Container with Multiple Elements"){
            ...
            *it = 10;
            ...
            // check that there are still 5 elements
            CHECK(container.size() == 5);

            // since 10 is now the biggest element, it should be the last one
            CHECK(*it2 == 1);
            ++it2;
            CHECK(*it2 == 2);
            ++it2;
        ...
        SUBCASE("Test Changing Last Element"){
            ...
            *it = -5;
            ...
            // since -5 is now the smallest element, it should be the first one
            ...
            // check that the rest of the elements are still in the container
            for(int i=0; i<container.size()-1; ++i) {
                CHECK(*it2 == arr[i]);
                ++it2;
            }
        ...
        SUBCASE("Test Changing First Element"){
            ...
            *it = 100;
            ...
            // since 100 is now the biggest element, it should be the last one
            CHECK(*it2 == 2);
            ++it2;
            CHECK(*it2 == 3);
            ++it2;
...
TEST_CASE("Test Correct Order"){
    ...
    SUBCASE("Test for Complex Numbers"){
        // create an array of 10 complex numbers with random real and imaginary parts
